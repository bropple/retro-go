...
static const char	*S9xMnemonics[256] =
{
	...
	"JSR", "AND", "JSL", "AND", "BITT", "AND", "ROL", "AND",
	"PLP", "AND", "ROL", "PLD", "BITT", "AND", "ROL", "AND",
	"BMI", "AND", "AND", "AND", "BITT", "AND", "ROL", "AND",
	"SEC", "AND", "DEC", "TSC", "BITT", "AND", "ROL", "AND",
	...
	"DEY", "BITT", "TXA", "PHB", "STY", "STA", "STX", "STA",
